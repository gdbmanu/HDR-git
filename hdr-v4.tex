...
L'étude du système nerveux, sous l'angle computationnel, a deux objectifs:
\begin{enumerate} 
...
champ des \textit{neurosciences}, qui ont connu un développement considérables au cours des trente dernières années,
avec l'apparition de nouvelles techniques de mesure permettant d'observer le cerveau en fonctionnement à
différentes échelles. Elles reposent en second lieu sur la \textit{modélisation mathématique et informatique}, qui a également
...
learning}). 
Un dernier champ de recherche, celui de la \textit{robotique autonome} et du contrôle moteur, est également impliqué, dans la mesure où le
...
Ce chapître est consacré à l'analyse des capacités d'expression des grands réseaux de neurones. 
...
Les signaux transitant de neurone à neurone via les axones du réseau sont dont une succession d'états hauts et
d'états bas qui présentent une ressemblance frappante avec les signaux digitaux produits par les calculateurs 
numériques. Cette analogie de forme masque une différence profonde dans les principes de traitement et
de transformation de ces signaux. 

\subsection{Champ moyen}

% neurone fréquentiel (champ moyen sur la trame temporelle

% modèle de wilson-cowan

% neural field

% réseaux aléatoires (Sompolinsky Cessac)

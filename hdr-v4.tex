...
{\color{Cyan}
	...
	Dans les réseaux récurrents capables de maintenir une activité persistante, 
	\begin{enumerate}
		\item La plasticité de Hebb facilite l'appariement de cette activité avec le signal présent en entrée du réseau.
		\item 
		Cet appariement se manifeste 
		 par une réduction de complexité de l'activité du réseau
		correspondant à la relaxation du système dynamique vers un attracteur de dimension faible.
		\item La convergence vers l'attracteur n'est pas immédiate. Elle correspond à un ``calcul'' réalisé par l'ensemble des neurones via des interactions locales uniquement. On parle de réponse de population.
	\end{enumerate}

...
L'amélioration du processus repose alors sur le fait de trouver de nouveaux paramètres $\Theta'$ en estimant la vraisemblance des paramètres étant donnée l'état latent, soit~:
...
\begin{itemize}
  ...
  \item sans mesure directe, mais avec un modèle d'environnement:
   ...
   {\color{Orange} En présence d'un contrôleur imparfait (ne conduisant pas à l'état désiré), il est souvent plus simple de biaiser la consigne dans un sens qui améliore le contrôle, sans modifier le contrôleur lui même, comme proposé par  {\color{Orange}[DEAN,ITO]}}

...
D'un point de vue calculatoire, $\boldsymbol{u}$ est le résultat d'un calcul effectué par 
le réseau à partir des données d'entrée. Dans la mesure où ce calcul est le résultat de 

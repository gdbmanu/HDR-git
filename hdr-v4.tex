...
\begin{itemize}
	...
	\item Cas particulier où il n'y a pas de transition d'état. Le processus de mesure seul est filtré, aboutissant à un mécanisme d'\textit{accumulation d'évidence}.
\end{itemize}

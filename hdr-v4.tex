...
\part{Principaux résultats et perspectives}
...
\section{Apprentissage et plasticité}
...
\paragraph{Le problème de l'assemblage (``\emph{Binding Problem}'')}
{\color{Violet}
...
\chapter{Toward STDP-based population action in large networks of spiking neurons}\label{app:ESANN14A}
\paragraph{Authors~:} Daucé E

...
plusieurs instituts (ISC, Lyon), et de masters de sciences cognitives.  
...
\subsubsection{Couplages sensori-moteurs (2000-2002)}
...
(équipe alors animée par Nicolas Franceschini) aux sciences sociales, en passant par les neurosciences, la psychologie 
...
\subsubsection{Neurones à impulsion \-- ACI ``DYNN'' (2002-2007)}
...
\subsubsection{Apprentissage dans les réseaux équilibrés \-- Thèse de Frédéric Henry (2005-2008)}
...
\begin{figure}[b!]
	...
	\caption{Architecture de contrôle.
...
\begin{figure}[t!]
	...
	\caption{{\bf Déplacements moteurs après apprentissage} (Rotation vs. temps) 
	{\bf(Haut)} {\color{Cyan} Successive positions of the robot after a motor command
...
scene).
{\bf(Bas, gauche)}  Example of recalibration after a shift. The
...
periodic sequence. {\bf(Bas, droit)} After the robot has reached its
...
\begin{figure}[t!]
	...
	\caption{{\bf Interconnection pattern for the perception-action network} 

...
\begin{itemize}
	...
	extraient des représentants caractéristiques des données (vecteurs supports). 
	\item Les approches explicatives \shortcite{Bishop2006}
	identifient la source cachée des observations (les facteurs causaux) selon des modèles probabilistes pré-définis.
...
\paragraph{Lien avec le biologie}

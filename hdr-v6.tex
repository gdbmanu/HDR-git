...
\pdfinfo{
	...
	/Title (HDR)
	/Keywords (Learning; Motor control; Neural networks)
...
\begin{titlepage}
	...
	{\Large Mémoire présenté en vue de l'obtention}
	\vskip .2cm
	{\Large du diplôme d'Habilitation à Diriger les Recherches }
	\vskip 1cm
	{\Large Spécialité Informatique}
	\vskip 2cm	
		{\Huge \textsc{Apprentissage et Contrôle} 
		\vskip 1cm
		\textsc{dans les Architectures Neuronales}}
		\vskip 2cm
		par
		\vskip .5cm
		{\Large Emmanuel \textsc{Daucé}}
   ...
   Travaux présentés le 18 Janvier 2016 devant un Jury composé de :		
		\begin{tabular}[t]{|l|l|}
			\hline
			Dr. Frédéric \textsc{Alexandre} & INRIA Bordeaux Sud Ouest (rapporteur) \\
			Dr. Benoît \textsc{Girard} & ISIR - Univ. Paris VI (rapporteur) \\
			Dr. Jean-Pierre \textsc{Nadal}  & LPS - Ecole Normale Supérieure, Paris (rapporteur) \\
			Pr. Manuel \textsc{Samuelides} & Institut Supérieur de l'Aeronautique et de l'Espace, Toulouse \\
			Dr. Rémi \textsc{Munos} &  Google DeepMind, Londres \\
			Pr. Liva \textsc{Ralaivola} & LIF, Aix-Marseille Université \\
			Pr. Laurent \textsc{Pézard} & LNIA, Aix-Marseille Université (président)\\
			\hline
		\end{tabular}
		\vfill		
...
\paragraph{}Je remercie Liva {\sc Ralaivola}, Professeur d'Informatique à la Faculté de Sciences d'Aix-Marseille Université pour avoir accepté d'endosser le rôle de tuteur pour ce travail, pour son soutien et sa relecture minutieuse.
Merci également à Bruno {\sc Torresani}, Professeur de Mathématiques à la Faculté de Sciences d'Aix-Marseille Université, et rapporteur interne de ce document, pour son exigence critique et ses conseils rédactionnels. 

\paragraph{}J'adresse toute ma reconnaissance à mes trois rapporteurs, Frédéric {\sc Alexandre}, Directeur de Recherche à l'INRIA Bordeaux-Sud Ouest, Benoît {\sc Girard}, Directeur de Recherche à l'Institut des Systèmes Intelligents et de Robotique,  et Jean-Pierre {\sc Nadal}, Directeur de Recherche au Laboratoire de Physique Statistique de l’École Normale Supérieure, et Directeur d’Études à l’École des Hautes Études en Sciences Sociales, pour leur disponibilité et leurs encouragements. Je remercie également Manuel {\sc Samuelidès}, Professeur de mathématiques à l'Institut Supérieur de l’Aéronautique et de l'Espace, Rémi {\sc Munos}, Directeur de Recherche à l'INRIA Lille Nord-Europe, actuellement en détachement à Google DeepMind à Londres, et Laurent {\sc Pézard}, Professeur en Neurosciences à la Faculté de Sciences d'Aix-Marseille Université, pour leur participation à l'animation de ce jury d'HDR. 

\paragraph{}Les travaux présentés ici sont le fruit de nombreuses collaborations et interactions pluridisciplinaires au sein de différents groupes de travail, ACI, ANR, conférences, rencontres, ateliers et réunions informelles dans les différents instituts où j'ai effectué mes recherches. Les collègues, maîtres et amis qui ont participé à mes travaux sont cités dans le document et il est impossible d'établir la liste de tous ceux dont les discussions, recherches et travaux ont permis d'en tisser les fils. 
Je tiens donc à remercier ceux qui, en mettant à disposition les conditions matérielles de la recherche, rendent possible son développement, ses bifurcations et ses ramifications nouvelles, et en particulier, pour leur accueil et leur ouverture pluridisciplinaire, Reinoud {\sc Bootsma}, ancien chef de l'équipe Dynamique du Mouvement et Directeur de l'Ecole Doctorale de Sciences du Mouvement Humain, et Jean-Louis {\sc Vercher}, ancien Directeur de l'Institut des Sciences du Mouvement, unité mixte CNRS rattachée à la Faculté des Sciences du Sport d'Aix-Marseille Université, ainsi que Viktor {\sc Jirsa}, Directeur de l'Institut de Neurosciences des Systèmes, unité mixte INSERM rattachée à la Faculté de Médecine d'Aix-Marseille Université. 

\paragraph{} Je remercie bien sûr mes collègues et confrères de l'Institut de Neurosciences de Systèmes, ainsi que ceux de l'équipe pédagogique Mathématiques et Informatique de l'Ecole Centrale de Marseille, pour leur bonne humeur au quotidien et leurs conseils dans les derniers préparatifs, et merci bien sûr à ma famille et à mes amis pour la joie et le soutien de tous les jours. 
...
\paragraph{}Ce mémoire d'Habilitation à Diriger les Recherches présente mes contributions à la recherche 
...
\paragraph{}Les modèles de réseaux de neurones étudiés sont des systèmes dynamiques de grande dimension, 
...
\paragraph{}L'apprentissage est abordé dans une 
...
\paragraph{}Le travail de relecture et de compilation, occasionné par la rédaction de ce mémoire, 
...
\paragraph{}This ``Habilitation à Diriger les Recherches'' dissertation presents my research contributions to   
%en modélisation mathématique et informatique des dynamiques neuronales et de l'apprentissage.
...
\paragraph{}The neural network models addressed here are high dimensional dynamical systems,
%définis par un graphe d'interactions entre des unités de calcul élémentaires. 
...
\paragraph{}Learning is addressed in a
%perspective neuro-réaliste, c'est-à-dire prenant en compte les principales contraintes biologiques, 
...
\paragraph{}The proofreading work and papers compilation, needed by the writing of this dissertation, 
%a également permis de mettre en lumière certaines difficultés fondamentales, 
...
Neurosciences), la conférence CoSyNe (Computational and Systems Neuroscience) ainsi que la conférence SAB (Simulation of Adaptive Behavior) dans le domaine de la robotique bio-inspirée. 
...
avait travaillé sur le comportement à taille finie (route vers le chaos) \shortcite{Doyon1993,CES94}.
...
à des patrons (stimuli) également aléatoires (voir section \ref{sec:NN98} page \pageref{sec:NN98} et annexe \ref{app:NN98}).
...
\shortcite{Dau99A,dau01a} (voir section \ref{sec:balanced} page \pageref{sec:balanced} et annexe \ref{app:NPL01}).
...
synchronisées) \shortcite{dau01a}. 
...
Le formalisme multi-couches est le même que celui utilisé dans les réseaux équilibrés (voir section \ref{sec:BioCyb02} page \pageref{sec:BioCyb02} et annexe \ref{app:BC02}).

Cette thèse m'a également permis d'assister à l'essor des neurosciences computationnelles au cours des 
...
l'application des modèles de champ neuronal au contrôle moteur \shortcite{Schoner95}, les modèles de formation des champs récepteurs \shortcite{Olshausen1997}, etc.
Dans le même temps, le domaine des réseaux de neurones artificiels se rapproche de plus en plus de l'apprentissage 
...
\shortcite{Quo00,Dau00b,Quoy2001,Dau02} (voir section \ref{sec:alt} page \pageref{sec:alt}). 
...
\begin{itemize}
 \item Etude sur le comportement critique des réseaux aléatoires de taille finie, dans le cadre d'une co-direction d'ouvrage \shortcite{Gui02} (voir section \ref{sec:criticalite} page \pageref{sec:criticalite}).
 ...
 permettant de développer des dynamiques méta-stables à ``foyers d'activité''  \shortcite{Dau04} (voir section \ref{sec:NatComp} page \pageref{sec:NatComp} et annexe \ref{app:NC04}). La combinaison de patrons de connexion à la fois topographiquement organisés et
 ...
 \item Apprentissage d'un contrôle moteur en boucle fermée, modèles Hebbiens de l'apprentissage par renforcement \shortcite{Dau04b} (voir section \ref{sec:SAB04} page \pageref{sec:SAB04} et annexe \ref{app:SAB04})
\end{itemize}
...
et d'un article \shortcite{Henry06,Dau06,henry07}  (voir section \ref{sec:discri} page \pageref{sec:discri} et annexe \ref{app:NCO07}).
\item
Deux articles
de conférences \shortcite{Hen08,Hen08B} étudient un protocole d'apprentissage où un réseau aléatoire est 
soumis à des motifs statiques aléatoires (comme dans \shortcite{Dau98A}), montrant un caractère régulateur de la règle de Hebb sur la dynamique du réseau (voir section \ref{sec:STDP} page \pageref{sec:STDP} et annexe \ref{app:NCP08}).
\item 
...
post-doctoral en 2010 sous notre supervision \shortcite{Dauce2011} (voir section \ref{sec:orientation} page \pageref{sec:orientation} et annexe \ref{app:CNS11B}). 

Deux études sur le rôle du codage topographique dans l'apprentissage d'une cinématique inverse, en collaboration avec Alain Dutech du LORIA,  ont également été réalisées dans ce cadre (voir section \ref{sec:topo-renf} page \pageref{sec:topo-renf} et annexes \ref{app:ICANN09} et \ref{app:NCO10}). 
...
en collaboration avec Gaurav Malhotra, chercheur post-doctorant en 2010-2011 sur cette question \shortcite{Malhotra2011} (voir section \ref{sec:orientation} page \pageref{sec:orientation} et annexe \ref{app:CNS11A}).
...
(section \ref{sec:BCI} page \pageref{sec:BCI} et annexe \ref{app:IJCNN15}). 
\end{itemize}
...
par \shortcite{Kindermans2012} (section \ref{sec:BCI} page \pageref{sec:BCI} et annexe \ref{app:ESANN14B}).
...
construits à partir du connectome \shortcite{Golos2013,Golos2015}. Nous sommes partis d'un 
...
large échelle (en particulier l'alternance entre différents patrons d'activité) \shortcite{Golos2015} (voir section \ref{sec:PLOSsub} page \pageref{sec:PLOSsub} et annexe \ref{app:PLOSsub}).
...
On parlera par la suite de \textit{réponse de population} (ou réponse collective)  \index{Réponse de population} lorsque le réseau ``réagit'' ainsi à une entrée particulière en réduisant son nombre de degrés de liberté.
...
\begin{itemize}
	...
	\item Une implémentation connue de ce principe dans le cadre des réseaux de neurones est le réseau ART \shortcite{Car87}, qui implémente un principe de ``vigilance'' correspondant à l'identification d'une entrée non-référencée par le réseau.
...
Ce modèle de plasticité synaptique, dite ``potentiation à long terme'' (Long Term Potentiation - LTP), a été confirmé à de nombreuses reprises par les observations \shortcite{Bli73,BI98}. 
...
Un réseau de Hopfield  est un graphe non-orienté et pondéré $G$, constitué de $N$ nœuds et défini par une matrice de couplages $\boldsymbol{J} = \{J_{i,j}\}_{i \in 1..N,j \in 1..N}$  ainsi que des seuils d'activation $\boldsymbol{\theta} = \{\theta_i\}_{i \in 1..N}$. La mise à jour de l'état du nœud $i$ repose sur l'observation locale de ses voisins, selon~:
$$x_i \leftarrow H(\sum_j J_{ij} x_j - \theta_i)$$
...
Ainsi, si $\boldsymbol{P}^{(1)}, ..., \boldsymbol{P}^{(K)}$ est une base de vecteurs binaires (images) de taille $N$, le choix :
$$
\left\{
\begin{array}{ll}
\forall i,j, & J_{ij} = \sum_k ({P}_i^{(k)} - 0.5) (P_j^{(k)}-0.5) \\
\forall i, & \theta_i = 0.5 \sum_j J_{ij}
\end{array}
\right.
$$
permet d'organiser l'espace d'états en un nombre fini de \textit{bassins d'attraction} associés aux différents motifs de la base. L'activité du réseau finit par converger vers un des ces patrons d'activité stationnaires, en fonction des conditions initiales. Chacun de ces attracteurs s'interprète ici comme une assemblée distincte, c'est-à-dire comme un circuit de renforcement mutuel aboutissant à la stabilisation d'un patron d'activité macroscopique. 
...
un  comportement générique de déstabilisation, appelé route vers le chaos par ``quasi-périodicité'' \shortcite{Berger1988,Doyon1993} (voir figure \ref{fig:hermes-bif} page \pageref{fig:hermes-bif}).
...
\paragraph{Remarque~:} La fonction solution $\phi_\text{in}(\boldsymbol{x}^*,.)$, lorsqu'elle existe, s'apparente à un \textit{programme moteur} qui conditionne la manière dont le contrôleur traite ses entrées sensorielles~: pour deux consignes différentes, les mêmes entrées sensorielles ne produisent pas la même réponse.  
...
\begin{align}
&\dot{\boldsymbol{x}}_\text{out} = \phi_\text{out}(\boldsymbol{x}_\text{out},\boldsymbol{u},\boldsymbol{\xi}_\text{out}) \label{eq:feed-noise-1} \\
&\boldsymbol{I} = h_\text{in}(\boldsymbol{x}_\text{out},\boldsymbol{\chi}_\text{out}) \label{eq:feed-noise-2}\\
&\dot{\boldsymbol{x}}_\text{in} = \phi_\text{in}(\boldsymbol{x}_\text{in},\boldsymbol{I},\boldsymbol{\xi}_\text{in}) \label{eq:feed-noise-3} \\
...
{\em Pour la simplicité de l'exposé, nous passons ici en notation discrète pour les indices temporels. La généralisation aux modèles à temps continu peut être trouvée dans \shortcite{Kushner1964}.}
...
\begin{itemize}
	...
	\begin{align}\boldsymbol{x}_\text{out}(t+1)\sim P(\boldsymbol{X}|\boldsymbol{x}_\text{out}(t),\boldsymbol{u}(t))
	\end{align}
...
\mathbb{P}(\boldsymbol{x}|\boldsymbol{I}(t+1)) = \frac{P(\boldsymbol{x}|\boldsymbol{x}_\text{out}(t),\boldsymbol{u}(t)) Q(\boldsymbol{I}(t+1)|\boldsymbol{x})}{\int_{\mathcal{X}}P(\boldsymbol{y}|\boldsymbol{x}_\text{out}(t),\boldsymbol{u}(t)) Q(\boldsymbol{I}(t+1)|\boldsymbol{y})d\boldsymbol{y}}
\end{align}  
où~:
\begin{itemize}
	\item $P(\boldsymbol{x}|\boldsymbol{x}_\text{out}(t),\boldsymbol{u}(t))$ est la probabilité \textit{a priori}.
	\item  $Q(\boldsymbol{I}(t+1)|\boldsymbol{x})$ est la vraisemblance de l'observation $\boldsymbol{I}$ étant donné $\boldsymbol{x}$. 
\end{itemize}
...
\begin{equation}\max_{\Theta',\boldsymbol{u}'}\int L(\boldsymbol{x},\Theta',\boldsymbol{u}')\hat{f}(\boldsymbol{x}) d\boldsymbol{x} \label{eq:Friston} %= \min_{\Theta',\boldsymbol{u}'} \int -  \log\hat{f}(\boldsymbol{x}) d\boldsymbol{x} 
\end{equation}
...
Les réseaux de neurones dits ``équilibrés'' (balanced neural networks) sont des réseaux  constitués d'une population de nœuds inhibiteurs et d'une population de nœuds excitateurs. Le terme équilibre se réfère ici à l'idée d'équilibre
...
En étendant les équations de champ moyen au cas des populations multiples, nous étudions dans \shortcite{dau01a} un régime de faible activité (où l'inhibition domine l'excitation). Nous regardons le comportement de deux paramètres de contrôle~: l'amplification et l'hétérogénéité d'un faisceau 
...
(voir section \ref{sec:multi_pop} page \pageref{sec:multi_pop} et annexe \ref{app:NPL01}).
...
Le modèle proposé dans \shortcite{Dau04b,Dau04} (voir section \ref{sec:NatComp} page \pageref{sec:NatComp} et annexe \ref{app:NC04}) met en évidence la présence simultanée d'une activité de fond chaotique,
...
L'étude proposée dans \shortcite{Golos2015} (voir section \ref{sec:PLOSsub} page \pageref{sec:PLOSsub}, et annexe \ref{app:PLOSsub}) étudie la 
...
L'étude présentée dans \shortcite{Dauce2011} (voir page \pageref{sec:orientation-spatiale} et annexe \ref{app:CNS11B})
montre l'existence d'une activité autonome contrôlée dans le temps et dans l'espace sur
...
\begin{equation}\dot{J}_{ij} = F(s_i^\text{out} \times s_j^\text{in},{J}_{ij}) \label{eq:plast-0}
\end{equation}
...
\cite{Hen08B} (voir section \ref{sec:STDP} page \pageref{sec:STDP} et annexe \ref{app:NCP08}), peu spécifiques et peu différents des comportement obtenus avec des neurones fréquentiels.
...
peut être amplifiée par la plasticité (voir figure~\ref{fig:ESANN14}, page~\pageref{fig:ESANN14}).
 ...
 l'émergence de séquences d'activation stables, comme postulé par \shortcite{izhikevich04,izh06} (et contrairement aux observations de \shortcite{morrison07}). 
...
De nombreux modèles de la perception utilisent ces principes pour rendre compte des temps de réponse à des stimuli plus ou moins ambigus \shortcite{Gold01,Simen2011,khoei2013}.
...
L'hypothèse du \textit{passage d'échelle} \index{Passage d'échelle} suggère des moments transitoires où l'activité microscopique rejoint 
...
\begin{itemize}
	...
	L'apprentissage des contingences sensori-motrices a récemment fait l'objet d'un projet européen (eSMC project \-- extended Sensori-Motor Contingencies). Ce type d'apprentissage est par ailleurs évoqué dans le cadre applicatif de la robotique développementale \shortcite{Andry2001,Revel2009}.
...
ou par bande de fréquences \shortcite{Skaggs1996,wang1996,WangXJ2010}. % [CITATIONS].
...
L'étude présentée dans \shortcite{Dau99A,dau01a} (voir annexe \ref{app:NPL01}) étudie le comportement d'un réseau dit ``équilibré'' (voir section \ref{sec:balanced}). 
...
en changeant les caractéristiques du seuil d'activation afin de contrôler le niveau d'activation moyen \cite{Golos2015} \-- voir annexe \ref{app:PLOSsub}.
Ces travaux ont permis de mettre en évidence un nombre très important d'attracteurs dans certaines gammes de paramètres.
...
L'article qui présente ces idées de la manière la plus complète est celui de Neural Networks \shortcite{Dau98A} (voir annexe \ref{app:NN98} page \pageref{app:NN98}).
...
stimulus étant l'expression d'une contrainte différente.
\item
L'ensemble des réponses aux contraintes statiques possibles constitue le \textit{répertoire dynamique} du réseau.
\end{itemize}
...
$${J}_{ij}(t) - {J}_{ij}(t-1) \propto (s_i^\text{out}(t)-0.5)\times(s_j^\text{in}(t-1)-0.5)$$
...
Maas et Markram \cite{MAASS2002,Buonomano2009}.
...
$${J}_{ij}(t) - {J}_{ij}(t-1) \propto (s_i^\text{out}(t)-m_i^\text{out}(t))\times(s_j^\text{in}(t-1)-m_j^\text{in}(t-1))$$
avec~:
...
\begin{itemize}
	...
	\begin{itemize}
		...
		l'émergence de séquences d'activation stables \shortcite{izhikevich04,izh06}.
		\item 
...
\cleardoublepage
\includepdf[pages=1,offset=70 -30]{pdf/2015-ijcnn.pdf}
\includepdf[pages=2,offset=-70 -30]{pdf/2015-ijcnn.pdf}
\includepdf[pages=3,offset=70 -30]{pdf/2015-ijcnn.pdf}
\includepdf[pages=4,offset=-70 -30]{pdf/2015-ijcnn.pdf}
\includepdf[pages=5,offset=70 -30]{pdf/2015-ijcnn.pdf}
\includepdf[pages=6,offset=-70 -30]{pdf/2015-ijcnn.pdf}
\includepdf[pages=7,offset=70 -30]{pdf/2015-ijcnn.pdf}
\includepdf[pages=8,offset=-70 -30]{pdf/2015-ijcnn.pdf}

\chapter{Multistability in large-scale models of brain activity}\label{app:PLOSsub}
\paragraph{Authors~:} Golos, M, Jirsa, V and Daucé, E
\paragraph{Journal~:} PLoS Computational Biology  11(12), e1004644
\cleardoublepage

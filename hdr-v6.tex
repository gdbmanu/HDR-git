...
\shortcite{Dau99A,dauce01a} (voir section \ref{sec:balanced} page \pageref{sec:balanced} et annexe \ref{app:NPL01}).
...
large échelle (en particulier l'alternance entre différents patrons d'activité) \shortcite{Golos2014} (voir section \ref{sec:PLOSsub} page \pageref{sec:PLOSsub} et annexe \ref{app:PLOSsub}).
...
L'étude proposée dans \shortcite{Golos2014} (voir section \ref{sec:PLOSsub} page \pageref{sec:PLOSsub}, et annexe \ref{app:PLOSsub}) étudie la 

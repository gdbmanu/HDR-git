...
\begin{titlepage}
	...
	\begin{center}
		...
		\vskip .5cm
			...
			INSERM UMR\_S 1106 	
		\vskip 3cm
	{\Large Mémoire d'Habilitation à Diriger les Recherches }
	\vskip 3.5cm
   ...
   Travaux présentés le 18 Janvier 2016 devant un Jury composé de :		
		\begin{tabular}[t]{|l|l|}
			...
			Dr. Rémi \textsc{Munos} &  Google DeepMind, London \\
...
\newpage
{\em
Je remercie Liva Ralaivola, Professeur d'informatique à la faculté de Sciences de l'Université d'Aix-Marseille pour avoir accepté d'endosser le rôle de tuteur pour ce travail, pour son soutien et sa relecture minutieuse.
Merci également à Bruno Torresani, Professeur de mathématiques à la faculté de Sciences de l'Université d'Aix-Marseille, et rapporteur interne de ce document, pour son exigence critique et ses conseils rédactionnels. 

J'adresse toute ma reconnaissance à mes trois rapporteurs, Frédéric Alexandre, Directeur de Recherche à l'INRIA Bordeaux-Sud Ouest, Benoît Girard, Directeur de Recherche à l'Institut des Systèmes Intelligents et de Robotique,  et Jean-Pierre Nadal, Directeur de Recherche au Laboratoire de Physique Statistique de l'Ecole Normale Supérieure, et Directeur d'Etudes à l'Ecole des Hautes Etudes en Sciences Sociales, pour leur disponibilité et leurs encouragements. Je remercie également Manuel Samuelidès, Professeur de mathématiques à l'Institut Supérieur de l’Aéronautique et de l'Espace, Rémi Munos, Directeur de Recherche à l'INRIA Lille Nord-Europe, et Laurent Pézard, Professeur en neurosciences à l'Université d'Aix-Marseille, pour leur participation à l'animation de ce jury d'HDR. 

Les travaux présentés dans ce document sont le fruit de nombreuses collaborations et interactions au sein des différents instituts au sein desquels j'ai effectué mes recherches. Merci en particulier à Reinoud Bootsma et Jean-Louis Vercher pour leur accueil au sein de l'Institut des Sciences du Mouvement ainsi que Viktor Jirsa, pour son accueil au sein de l'Institut de Neurosciences des Systèmes. 

Parmi tous les collègues, coauteurs, étudiants et ...

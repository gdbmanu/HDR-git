...
Les connaissances en plein essor sur le fonctionnement
du cerveau permettent d'envisager de nouvelles méthodologies 
...
computationnels à l’œuvre dans le cerveau 
que l'on pourra peut-être repenser la manière de concevoir des objets communicants (robots mobiles
mais également interfaces vocales, jeux, etc.) à travers des modes de communication
plus proches de ceux qu'un sujet expérimente quotidiennement avec son environnement.
...
Ce travail de relecture et de compilation a également été l'occasion de mettre en lumière certaines difficultés fondamentales liées à la modélisation de l'apprentissage de compétences motrices.
...
Ce rapport propose donc quelques pistes de recherche pour y remédier, à travers des principes de contrôle moteur fondés sur la \textit{rétroaction positive}.

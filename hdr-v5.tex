...
\item Le second pôle concerne l'étude des dynamiques de populations de neurones. Les neurones sont dans ce cadre des unités de traitement simplifiées (neurones à spikes, neurones stochastiques, neurones fréquentiels,...). Le but est de comprendre les interactions entre de grands groupes de neurones, et d'étudier les conditions d'émergence de certaines signatures d'activité (corrélations large échelle, couplages de phase, champs récepteurs, ...) observés en électrophysiologie chez le sujet sain et dans les pathologies nerveuses.
	...
	\begin{itemize}
		\item L'activité des populations de neurones, qui est (i) irrégulière \cite{Softky1993}, et (ii) de faible fréquence \shortcite{Dean1981}, se modélise comme un régime de ``haute conductance''  \shortcite{Shadlen1998,Van98,brunel00,Destexhe2003}, correspondant à un équilibre dynamique entre les influences excitatrices et les influences inhibitrices au sein d'une même population. 
		\item Les neurones travaillent dans un régime ``sous-critique'' \shortcite{Pasquale2008,Rubinov2011,Palva2013}, c'est à dire très proches de leur seuil de décharge. La présence de fréquences caractéristiques dans l'activité des neurones \shortcite{Bremer1949} traduit la proximité de la frontière avec un régime d'oscillations synchronisées \shortcite{Wang1996,brunel00,WangXJ2010}.
		\item Les populations de neurones peuvent conserver une activité soutenue en l'absence de stimulation par des mécanismes de réverbération internes \shortcite{Ama77B,Hop82,Cam98,Bru01,Lansner2009}. %La synchronisation de phase tels qu'observée lors de la réalisation de certaines tâches \shortcite{Gra89} peut s'expliquer par un accrochage de fréquence entre différentes 
...
%		\item  . , (iv) et des corrélations à large échelle ,
	\end{itemize}
...
Les principales avancées dans ce cadre sont~:
	\begin{itemize}
	 \item Les modèles du système visuel, inspirés des observations de Hubel et Wiesel, meten en évidence une organisation hiérarchique ds couches de traitement visuelles.  e système Visuel, Olshausen, les champs récepteurs, les architectures profondes, approche profonde; non-negative matrix factorization [LEE + SEUNG 1999][Rao-Ballard]. sparse représentation.
	 \item modèles de l'hippocampe
	 \item modèles des ganglions de la base
	 \item modèles bayésiens bruit dans l'activité neuronale interprété 
		\item Populatino coding, Gibbs sampling, Free energy
		\item Modèles de l'apprentissage, du renforcement et de la sélection de l'action
	\end{itemize}
\end{enumerate}
...
Le chapitre 2 présente certains grands principes lié à la modélisation biologiquement inspirée des réseaux de neurones. Il s'adresse principalement aux non-spécialistes du domaine.
Le chapitre 3 présente les principes fondamentaux de l'apprentissage et du contrôle tels qu'on les trouve dans la littérature. Il sert de point d'appui à la compréhension des principaux résultats de mon activité de recherche, présentés dans le chapitre 4. Enfin, le chapitre 5 met en perspective ces différents résultats, et développe plusieurs pistes d'études pouvant servir de base à des travaux futurs.
...
Le chapitre 6 aborde la question de l'expressivité des grands réseaux de neurones récurrents, c'est à dire de leur capacité à traiter et transformer des signaux. Le chapitre 7 aborde la question de la plasticité, en lien avec l'apprentissage de dépendances temporelles et de prédiction des signaux. Enfin, le chapitre 8 traite la question des interactions entre un contrôleur neuronal et son environnement, dans le cadre de l'apprentissage moteur.

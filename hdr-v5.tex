...
%Ces travaux reposent, comme nous le verrons, sur un certain nombre de choix méthodologiques~:
 Les modèles étudiés sont des systèmes dynamiques de grande dimension, 
	définis par un graphe d'interactions entre des unités de calcul élémentaires. Nous étudions les principes du calcul ``collectif'' 
    ...
    L'aléa des connexions permet donc de structurer l'espace des entrées sensorielles
    en régions distinctes, autrement dit ``digitalise'' ses entrées, selon un principe 
    d'{``auto-encodage''}.
    
	L'apprentissage automatique est abordé dans une perspective neuro-réaliste. 
	Nous prenons en compte les contraintes biologiques, comme la contrainte de localité de Hebb, 
	le caractère récurrent du graphe de connexions, ou encore le caractère 
	discret des signaux émis par les neurones, pour développer nos modèles. Dans ce cadre, 
	...
	dites ``en boucle fermée''. Nous cherchons dans ce cadre à étendre 
	...
	Dans ce cadre, nous avons contribué à établir une correspondance entre la règle de Hebb, 

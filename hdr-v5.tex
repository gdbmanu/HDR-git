...
\subsubsection{j. L'appariement par ``accumulation d'évidence'' implémente un mécanisme de mise à jour et de révision des croyances dans un espace de choix concurrents.}
...
\subsubsection{k. La durée d'une commande balistique peut être contrôlée par un mécanisme d'intégration sous-liminaire}
...
\begin{itemize}
	\item Cette approche est mise en oeuvre dans le cadre d'un clavier virtuel P300 guidé par une touche ``backspace''  \shortcite{Dauce2013b,Dauce2015} (voir page et annexe \ref{app:IJCNN15}). 
	\begin{itemize}
		...
		\item Nous montrons également, dans le cas d'environnements non-stationnaires 
	\end{itemize} 
	...
	Contrairement à l'algorithme du banditron généralement utilisé dans ce cadre \shortcite{Kakade2008}, cette propriété conduit également à la possibilité de politiques d'exploration avec un bruit arbitrairement petit, autrement dit à une politique générale de choix non-stochastique.
\end{itemize}

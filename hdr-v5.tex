...
Etendu au cas des systèmes de contrôle en boucle fermée, l'appariement par feedback positif suppose une double relaxation, à la fois du dispositif mécanique et du contrôleur neuronal, vers un attracteur comportemental mutuel (étude {\bf i}). La réduction de la dynamique d'ensemble devrait en outre permettre, transitoirement, de faire fonctionner les ensembles de neurones aux mêmes échelles de temps et d'espace que les déplacements moteurs associés.
...
Il semble y avoir une séparation conceptuelle et pratique entre d'une part l'approche systèmes dynamiques, d'autre part la reconnaissance de formes. 
...
\paragraph{Disparités d'échelle}
Le problème des disparités d'échelle, pourtant connu de longue date dans le champ des sciences cognitives, désigne la difficulté à considérer sur le même plan~:
\begin{itemize} 

...
en neurosciences computationnelles, apprentissage automatique et contrôle moteur. Ces travaux s'inscrivent dans une perspective neuromimétique 
...
Les modèles utilisés en apprentissage prennent en compte les contraintes biologiques, comme la contrainte de localité de Hebb, 
	le caractère récurrent du graphe de connexions, ou encore le caractère 
	discret des signaux émis par les neurones.
	Nous cherchons également à prendre en compte 
	les causalités circulaires existant entre le réseau et son environnement, 
 ...
 Dans ce cadre, 
	 ...
	 En étendant ces principes au cas du contrôle moteur, nous avons également contribué à établir une correspondance entre la règle de Hebb, 
...
par opposition au  ``contrôle du déplacement'' utilisé en théorie du contrôle classique. Différents projets sont proposés, visant à développer ces idées dans le cadre des modèles  de l'activité du cerveau à large échelle, ou encore dans le cadre des interfaces cerveau-machine.

...
\subsubsection{g. Dans les réseaux aléatoires de neurones à impulsions, la STDP permet de construire une fonction de réponse arbitraire sur un espace  d'entrée de séquences d'activation.}
...
\subsubsection{h. Dans des espaces d'action continus, l'apprentissage par renforcement peut être implémenté via la plasticité Hebbienne induite et le principe de trace synaptique. La dynamique endogène chaotique joue le rôle d'un bruit d'exploration.}
...
en place dans le cadre de ces tâches de contrôle en boucle fermée fonctionnent selon des principes d'appariement ``classiques'', 

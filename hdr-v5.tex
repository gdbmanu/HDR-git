...
Les modèles utilisés en apprentissage prennent en compte les contraintes biologiques, comme la contrainte de localité de Hebb, 
 ...
 Dans ce cadre, 
		...
		et un dictionnaire de formes reconnaissables par le réseau.
	 Dans le cadre du contrôle moteur, nous avons également contribué à établir une correspondance entre la règle de Hebb, 
...
par opposition au  ``contrôle du déplacement'' utilisé en théorie du contrôle classique. Différents projets sont proposés, visant à développer ces idées sur des modèles  de l'activité du cerveau à large échelle, ou encore dans le cadre des interfaces cerveau-machine.

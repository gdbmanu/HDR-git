...
Cette approche est basé sur un modèle \textit{génératif}  $P(\boldsymbol{X}|\boldsymbol{x},\boldsymbol{u},\Theta)$ et $Q(\mathcal{I}|\boldsymbol{x},\Theta)$, où $\Theta$ est le jeu de paramètres définissant les deux distributions.  
...
\chapter{Problématique d'ensemble}

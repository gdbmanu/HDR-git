...
Les réponses induites par la STDP s'apparentent à des ``bursts'' (bouffées) d'activité, qui impliquent 
...
\subsubsection{z. Dans des espaces d'action continus, l'apprentissage par renforcement peut être implémenté via la plasticité induite et le principe de trace synaptique.}

...
par le graphe, et les contraintes externes, exprimées par le signal, via une \textit{relaxation} vers la dynamique stationnaire. 
...
\begin{itemize}
	\item L'article \shortcite{Dau98A} met en évidence  une simplification systématique de l'activité intrinsèque dans le cas d'une règle d'ordre 0. 
	La réponse au motif

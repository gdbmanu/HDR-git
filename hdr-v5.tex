...
en neurosciences computationnelles, apprentissage automatique et contrôle moteur. 
...
Les résultats s'appuient en grande partie sur les comportements de systèmes dynamiques de grande dimension, c'est  dire constitués par l'interaction de nombreuses unités couplées. Nous montrons que, dans ce cadre, la reconnaissance de formes fonctionne selon le principe de la \textit{rétroaction positive} (ou résonance) entre un signal présenté en entrée  et une des ``formes'' possibles que peut prendre l'activité du réseau.
Ce principe semble pouvoir s'étendre au cas de l'apprentissage moteur.
Néanmoins, le travail de relecture et de compilation occasionné par la rédaction de ce rapport a permis de mettre en lumière certaines difficultés fondamentales, qui freinent la possibilité d'émergence d'une loi de contrôle dans un espace d'actions continu.
Ce rapport propose donc quelques pistes de recherche pour y remédier, en proposant en particulier de développer des principes de contrôle moteur fondés sur la rétroaction positive, par opposition au cadre classique de la rétroaction négative.

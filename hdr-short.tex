...
dans l'équipe de Reonoud Bootsma, puis au sein
...
Dans le premier chapître, nous abordons la question de substrat, en tant que  support de la communication (le hardware). 
...
Le second chapître présente une série de résultats est regroupée sous le thème de la ``subjectivité perceptive''. Les modèles présentés
...
Le troisième chapître aborde la question plus globale de la formation des comportements moteurs. 
...
Le quatrième chapître présente une série de résultats relatifs à des projets plus directement orientés vers la modélisation des mécanismes perceptifs et moteurs
...
Notre étude a donc ouvert la voie à l'étude multi-population systématique des réseaux de neurones à connectivité aléatoire \shortcite{Faugeras2009,Cabana2013}. %L'accent sur l'équilibre dynamique entre populations escitatrice et inhibitrice
...
auquel cas le principe de l'observateur peut être appliqué \cite{Kalman1960,Wolpert2000}}.
...
permis d'identifier des comportements caractéristiques, décrits sous la forme de différents régimes dyamiques. 
Nous avons cherché à caractériser l'expressivité de ces substrats (voir également l'annexe 2), c'est à dire leur capacité à produire
...
mis en évidence l'existence de deux paramètres d'ordre caractéristiques (l'amplification et l'homogénéité d'un fasceau 
d'axones) jouant sur la nature des régimes développés (extinction, activité chotique non spécifique et oscillations 
...
de l'environnement \shortcite{Beslon2002}. La combinaison de patrons de connexion en chapeau mexicain et d'un activité périodique
intrinsèque permet d'implémenter des mécanismes de mémoire à court terme sur des neurones impulsionnels,
...
mettent en évidence des régions de forte multistabilité, permettant à la fois d'analyser les affinités fonctionelles
...
de ce schéma est donc essentiellement celle d'un fonctionnement discret, la résonance perceptive étant
analogue fonctionnellement aux schémas
basés sur l'accumulation d'évidence (ou vraisemblance Bayésienne) \shortcite{Haruno2001,Friston2010}.
...
complexité selon un principe déjà suggéré par la synergétique \cite{Haken1983}.
...
en place dans le cadre de tâche de contrôle en boucle fermée fonctionnent de manière ``classique'', 
...
Nous avons également émis des hypothèses sur le rôle de cette activité intrinsèque pour produire 
...
Les modèles développés dans un cadre de modélisation biologique apportent quelques éclairages supplémentaires
sur certains aspects du calcul neuronal.
L'étude des mécanismes neuronaux d'orientation visuelle en particulier
mettent en évidence deux caractéristiques : 
- commande motrice simultanée avec le déplacement (co-extensivité)


Néanmoins, [TODO] -- Liste des problèmes

- mélange entre activité discrète et activité continue (feed+ et feed -?) - pas franchement identifié dans la littérature

- problème de la simultanéité (déplacement et activité motrice) - point fondamental : la pensée est le mouvement.

- problème de la permanence - hypothèse de la scène prémotrice

- problème du bruit créateur / bruit lent / bruit comme déformation / bruit sous forme de résonance incidente 

- problème du modèle forward (et/ou des opérations, translations, distances) dans un milieu digital

...
Nous abordons dans le premier chapître la question du support de communication,  relativement au fait
...
Dans le second chapître, nous abordons la question de substrat, en tant que  support de la communication (le hardware). 
...
Le troisième chapître présente une série de résultats est regroupée sous le thème de la ``subjectivité perceptive''. Les modèles présentés
...
\chapter{Systèmes dynamiques, correspondance de formes et substrat neuronal}\label{sec:pat}
...
comme dans le cadre du contrôle vestibulaire \cite{Ito1982}.
...
Tout comme les mécanismes de feedback négatifs, les oscillateurs comportementaux font l'objet
d'une littérature abondante.
[TODO Haken - Kelso - Schöner]
Les mécanismes neuronaux à la base des oscillateurs comportementaux, présents au niveau de la moëlle épinière,
commencent également à être bien connus [GRILLNER].

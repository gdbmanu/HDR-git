...
qui rend difficile les opérations de ce type. Une transformation qui, étant donnés des 
...
par \shortcite{Konig91a} (voir également \shortcite{Rod99,Wang2010,Dehaene2011}) 
...
L'introduction d'une démarche computationnelle, utilisant éventuellement des connaissances
acquises lors de mesures invasives, devrait en principe permettre de traiter, sous une forme peut-être élémentaire,
ces changements d'état rapide, ce qui devrait, en principe,  améliorer l'interprétation 
du signal et donc la fiabilité de l'interface.

\subsection{Maths-Info}

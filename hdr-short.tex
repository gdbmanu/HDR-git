...
de ce schéma est essentiellement celle d'un fonctionnement discret, la résonance perceptive étant
analogue fonctionnellement aux schémas
basés sur l'accumulation d'évidence (ou vraisemblance Bayésienne) \shortcite{Haruno2001}, 
l'analogie ayant principalement été notée par \shortcite{Friston2010}.
...
\chapter*{Annexe : systèmes dynamiques, correspondance de formes et approches mixtes}\label{sec:pat}
...
sous la forme d'oscillateurs simples ou couplés \shortcite{Haken1985,Strogatz2001}, servant de support à schémas moteurs périodiques.
...
\chapter*{Expressivité des substrats neuronaux}

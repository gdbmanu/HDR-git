...
Ces mêmes schémas sont par ailleurs à l'oeuvre dans la réalisation d'architectures de contrôle
...
Si on se restreint à un cadre computationnel pur, la plasticité 
...
Une idée dans l'air du temps \cite{Friston2010}, 
...
La question n'est plus la capacité à reproduire fidèlement le monde extérieur, mais la capacité à le prédire correctement. 
...
L'idée est de prendre appui sur cette approche relativement nouvelle (les modèles computationnels pour
le ``predictive coding'' datent
des années 2000 \cite{Rao1999}, mais la définition proposée par Friston dans un cadre du contrôle
...
Si nous poursuivons l'analogie nerveuse, le corps (les articulations du corps) décrit 
...
notre grand-mère) \shortcite{Quiroga2005}
...
par \cite{Konig91a} basé sur les résonances entre oscillateurs. Il reste néanmoins
...
deux laboratoires de neurosciences directement intéresés par les problématiques de modélisation : l'INT
...
par Viktor Jirsa et Randy McIntosh.
...
Toutes les données de la littérature indiquent que 
l'activité motrice est le ``reflet'' d'une activité mécanique prenant place dans l'environnement
physique externe.
Des études portant sur le cortex moteur montrent également des corrélations entre l'activité mesurée sur les neurones du cortex moteur et le
...
Cette correspondance terme à terme entre une activité et un déplacement moteur n'est pas
...
les activités  se développant 
de manière simultanée avec des activités motrices mesurables par des dispositifs externes (comme une caméra
...
Modéliser une telle activité implique par ailleurs
...
La première piste, qui est l'objet de la thèse de Mathieu Golos, s'oriente sur
l'analyse structurelle  - modes de fonctionnement - grandes structures fonctionnelles...

Deusième piste : modelisaton sous-corticale dans le cadre de TVB


Troisième piste : analyse de l'alternance - Britz
simultanéité. 

epilepsie et fonctions exécutives - catégorisation?




Dans le cadre de la modélisation du sujet épileptique, différents aspects peuvent 



Dans le domaine des neurosciences dites cognitives, de nombreux projets tournent autour de
la 


Les projets actuellement développés au sein de l'Institut
de neurosceinces de Systèmes 

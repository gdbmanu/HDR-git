...
\section{Substrats computationnels et expressivité}
...
Les réseaux de neurones naturels nous offrent un bon exemple pour caractériser des mécanismes 
computationnels différents de ceux qui sont à l'oeuvre dans les architectures computationnelles standard, 
de type Von Neumann. 
%dans la mesure où, à 
...
L'exemple des réseaux de Hopfield \shortcite{Hop82} offre ainsi un éclairage différent 
...
\section{Plasticité et apprentissage}
...
Nous avons regardé en particulier le cas de la période préparatrice variable (``variable foreperiod''), c'est 

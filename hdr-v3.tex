...
\subsection{Oscillations en neurosciences}
...
\subsection{Typologie des modèles de la perception}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\cleardoublepage
\section{Apprentissage de séquences spatio-temporelles dans les architectures multi-couches}

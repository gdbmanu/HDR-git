...
\emph{\bf Idée de circuit aléatoire : par analogie avec le substrat neuronal biologique : un circuit, avec des portes logiques, 
...
\begin{itemize}
	\item reconnaissance (\emph{recognition})
	\item rappel (\emph{recollection})
	\item
\end{itemize}
...
\subsubsection{Apprentissage et plasticité}
...
[Résultats sur la reconnaissance de séquences temporelles]
...
\chapter{Réservoir, résonance et apprentissage séquentiel} \label{sec:FPos}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\cleardoublepage
\section{Résonance dans les architectures multi-couches}

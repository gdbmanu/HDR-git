...
Cette approche a environ une soixantaine d'années d'existence, {\bf !!!FLOU!!!et se confond parfois avec} 
...
\emph{Les notions et éléments de vocabulaire présentés ci-dessous présentent un point de vue personnel (non nécessairement
...
\emph{Cette tentative n'est ni la première, ni totalement originale. 
...
\emph{En particulier, chaque élément de vocabulaire qui n'appartient pas au domaine des sciences de l'information est introduit 
...
\subsection{Substrats computationnels et expressivité}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%% substrat = MATERIEL  (!= LOGICIEL) 
...
La notion d'\emph{expressivité} d'un substrat {\bf !!!FLOU!!! tourne autour de} cette notion de limitation.
...
\subsection{Robotique et contrôle moteur}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
L'approche "multi-échelles" en neurosciences

% % A ne pas confondre avec les approches ondelettes

\section{problématiques spécifiques}

\subsection{Pattern matching vs. contrôle}

\subsection{Feedback + vs. feedback -}

%%%%%%%%%%%%%%%%
% NEW CHAPTER! %
%%%%%%%%%%%%%%%%

\part{Vue d'ensemble des résultats}
...
% 1998
Une étude sur les réseaux de neurones à connectivité aléatoire 
...
l'étude du comportement à taille finie d'un modèle de réseau de neurones aléatoire (RNA) multi-populations (voir section \ref{sec:balanced}).
...
Ces résultats sont détaillés dans les chapitres suivants:
\begin{itemize}
...
\emph{Ce chapitre présente enfin un certain nombre de questions laissées ouvertes par ces travaux, et présente
...
\emph{Dans la plupart des études que nous avons présentées, le fonctionnement du système nerveux nous a servi de guide pour
...
\emph{L'approche mise en avant dans ce chapitre
est l'analyse des capacités d'un réseau de neurones en tant que support potentiel d'opérations cognitives. 
...
\emph{Nous abordons la question de substrat, en tant que  support de la communication (le hardware). 
...
\includepdf[pages={11},offset=70 -20]{pdf/2007-epj-st-ann.pdf}
\includepdf[pages={12},offset=-70 -20]{pdf/2007-epj-st-ann.pdf}
...
\includepdf[pages=1,offset=-60 -20]{pdf/2015-PLOS-CB-ann.pdf}
\includepdf[pages=2,offset=60 -20]{pdf/2015-PLOS-CB-ann.pdf}
\includepdf[pages=3,offset=-60 -20]{pdf/2015-PLOS-CB-ann.pdf}
\includepdf[pages=4,offset=60 -20]{pdf/2015-PLOS-CB-ann.pdf}
\includepdf[pages=5,offset=-60 -20]{pdf/2015-PLOS-CB-ann.pdf}
\includepdf[pages=6,offset=60 -20]{pdf/2015-PLOS-CB-ann.pdf}
\includepdf[pages=7,offset=-60 -20]{pdf/2015-PLOS-CB-ann.pdf}
\includepdf[pages=8,offset=60 -20]{pdf/2015-PLOS-CB-ann.pdf}
\includepdf[pages=9,offset=-60 -20]{pdf/2015-PLOS-CB-ann.pdf}
\includepdf[pages=10,offset=60 -20]{pdf/2015-PLOS-CB-ann.pdf}
\includepdf[pages=11,offset=-60 -20]{pdf/2015-PLOS-CB-ann.pdf}
\includepdf[pages=12,offset=60 -20]{pdf/2015-PLOS-CB-ann.pdf}
\includepdf[pages=13,offset=-60 -20]{pdf/2015-PLOS-CB-ann.pdf}
\includepdf[pages=14,offset=60 -20]{pdf/2015-PLOS-CB-ann.pdf}
\includepdf[pages=15,offset=-60 -20]{pdf/2015-PLOS-CB-ann.pdf}
\includepdf[pages=16,offset=60 -20]{pdf/2015-PLOS-CB-ann.pdf}
\includepdf[pages=17,offset=-60 -20]{pdf/2015-PLOS-CB-ann.pdf}
\includepdf[pages=18,offset=60 -20]{pdf/2015-PLOS-CB-ann.pdf}
\includepdf[pages=19,offset=-60 -20]{pdf/2015-PLOS-CB-ann.pdf}
\includepdf[pages=20,offset=60 -20]{pdf/2015-PLOS-CB-ann.pdf}
\includepdf[pages=21,offset=-60 -20]{pdf/2015-PLOS-CB-ann.pdf}
\includepdf[pages=22,offset=60 -20]{pdf/2015-PLOS-CB-ann.pdf}
\includepdf[pages=23,offset=-60 -20]{pdf/2015-PLOS-CB-ann.pdf}
\includepdf[pages=24,offset=60 -20]{pdf/2015-PLOS-CB-ann.pdf}
\includepdf[pages=25,offset=-60 -20]{pdf/2015-PLOS-CB-ann.pdf}
\includepdf[pages=26,offset=60 -20]{pdf/2015-PLOS-CB-ann.pdf}
\includepdf[pages=27,offset=-60 -20]{pdf/2015-PLOS-CB-ann.pdf}
\includepdf[pages=28,offset=60 -20]{pdf/2015-PLOS-CB-ann.pdf}
\includepdf[pages=29,offset=-60 -20]{pdf/2015-PLOS-CB-ann.pdf}
\includepdf[pages=30,offset=60 -20]{pdf/2015-PLOS-CB-ann.pdf}
\includepdf[pages=31,offset=-60 -20]{pdf/2015-PLOS-CB-ann.pdf}
\includepdf[pages=32,offset=60 -20]{pdf/2015-PLOS-CB-ann.pdf}
\includepdf[pages=33,offset=-60 -20]{pdf/2015-PLOS-CB-ann.pdf}
\includepdf[pages=34,offset=60 -20]{pdf/2015-PLOS-CB-ann.pdf}
\includepdf[pages=35,offset=-60 -20]{pdf/2015-PLOS-CB-ann.pdf}
\includepdf[pages=36,offset=60 -20]{pdf/2015-PLOS-CB-ann.pdf}
\includepdf[pages=37,offset=-60 -20]{pdf/2015-PLOS-CB-ann.pdf}
\includepdf[pages=38,offset=60 -20]{pdf/2015-PLOS-CB-ann.pdf}
...
\chapter{Feedback positif et plasticité dans les modèles de la perception} \label{sec:FPos}
...
\emph{Ce chapitre présente une série de résultats regroupés sous le thème de la ``subjectivité perceptive''. Les modèles présentés
...
\chapter{Contrôle et apprentissage en boucle fermée}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%     3.1      %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\emph{Ce chapitre aborde la question plus globale de la formation des comportements moteurs. 
...
\emph{Ce chapitre présente une série de résultats relatifs à des projets plus directement orientés vers la modélisation des mécanismes perceptifs et moteurs

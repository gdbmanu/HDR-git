...
Ce rapport {\bf!!évite les détails mathématiques!!}, et insiste sur la mise en perspectives des travaux présentés
...
\emph{\footnotesize It turns out that systems of the form (6) have vastly different characteristics from linear systems. 
...
\subsection{Approche ascendante (``\emph{bottom-up}'')}
...
\subsection{Approche descendante (``\emph{top-down}'')}
...
Un second modèle, présenté dans \shortcite{Dau07}, implémente cette fois-ci le principe F2007-

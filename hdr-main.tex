...
Le papier de SAB (2001) \cite{Dau01b} comporte une partie montrant l'effet de l'apprentissage sur des signaux mixtes composés
...
Il est intéresant dans ce cadre d'étudier comment la plasticité interagit avec la dynamique de population 
...
constitués d'unités binaires (autrement dit neurones à spikes sans mémoire).
...
Frédéric Henry a travaillé sur un simulateur de résaux de neurones à spikes qu'il a développé lui-même.
...
Les échelles de temps et d'espace des comportements macroscopiques (mouvements, déplacements, activité courante)  
...
A l'inverse, l'activité nerveuse s'inscrit dans un substrat où l'intensité des interactions est 
...
L'interaction d'un substrat logiciel avec un domaine extensif passe par des transducteurs qui sont les canaux de 
...
Une architectures cognitives est un dispositif logiciel visant à permettre à un appareil 
d'enrichir ses comportements au cours d'interactions répétées avec son milieu. 
...
Avec une nuance : ces améliorations peuvent passer par deux stratégies : l'amélioration du logiciel et/ou l'amélioration du milieu.
Si le milieu contient des éléments nocifs ou aversifs par exemple, l'amélioration 
peut asser par une augmentation de la sensibilité logicielle à une classe de signaux 
associés à la sensation aversive, afin de mieux les éviter. 
Un autre stratégie est d'agir sur le milieu, en éloignant physiquement
les facteurs aversifs du lieu où l'appareil évolue. 
...
Plus généralempent, la prise en compte des deux domaines matériels que sont le circuit logiciel et le milieu physique
environnant conduit à définir la problématique de l'apprentissage et de la plasticité dans un cadre dit 
de ``boucle fermée'', qui est logiquement différent du cadre classique de l'apprentissage dit ``en
boucle ouverte''. Dans un cadre d'apprentissage en boucle ouverte, les actions physiques sur le milieu
sont découplées des sensations. 

[C'EST QUOI UNE REPONSE? DEPLACEMENT MOTEUR? ]

Dans le cadre de l'apprentissage en boucle fermée, les actions physiques sur le milieu sont couplées 
aux signaux sensoriels. 



à travers la notion d'action conjuguée. [AGIR SUR]



selon des in
dicateurs variés
comme la consommation énergétique, l'exposition aux signaux nociceptifs ou euceptifs, ou encore 
la réduction d'incertitude, le tout 

...
L'étude que nous avons présentée dans [NPL 2001] étudie le comportement d'un réseau équilibré de ce type. Ce papier 
...
(auquel cas les tirages aléatoires sont effectués sur des ``paquets d'axones'' reliant une population de neurones $p \in 1..K$ à une
population de neurones $q \in 1..K$, où $K$ est le nombre de populations).

L'étude numérique un rapport excitation/ inhibition qui est fixé à 1/2 (correspondant à un régime
de faible activité). Nous étudions le rôle contrasté de deux paramètres d'ordre. 
...
Un second paramètre, nommé $d$, représente l'inverse du \emph{coefficient de variation} des liens, autrement dit leur 
...
La question de l'hologénéité/hétérogénéité est revenue à l'ordre du jour. Plusieurs papiers récents bla bla...

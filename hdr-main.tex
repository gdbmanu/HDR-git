...
la commande motrice et l'agencement postural final. Toute 
posture impliquant un 
...
seuls.
Dans le cas de la rétine, ce ne sont pas nécessairement les mêmes neurones 
qui s'activent entre l'ancienne scène sensorielle (avant saccade) et
la nouvelle scène sensorielle (après saccade).

La scène extérieure doit donc se construire en tant qu'explication
des contenus perceptifs, étant donné un a priori d'invariance. 
...
Une scène peut donc être vue comme une série de couples (posture, scène visuelle).

L'évidence apparente de cette remarque cache de nombreuses difficultés.
En particulier, les points de vue sont expérimentés en séquence, et ne sont jamais 
vus simultanément. 
...
%la scène subjective .
une activité persistante spécifique.
Cette activité doit en particulier résister aux changements posturaux et sensoriels
incessants, c'est à dire être la seule à être congruente à tous ces changements posturaux et sensoriels
(la seule clé d'interprétation possible).
On peut voir cette activité congruente comme un ensemble d'objets placés sur une scène sombre,
dont un projecteur qui se déplace confirme ou infirme l'existence. Au fur et à 
mesure de ces déplacements du projecteur, une seule et unique interprétation demeure (la seule à
...
On peut néanmoins distinguer dans la littérature 
trois grands types d'approches pour aborder ce problème.

La recherche d'invariants perceptifs appartient à la grande tradition 
...
, ignore néanmoins certains aspects de l'expérience 

(ou plus généralement des plans d'utilisation)
[APPROCHE SEQUENTIELLE].



Un des problèmes sous-jacents bien connus est le ``binding problem'' (problème de la liaison): 

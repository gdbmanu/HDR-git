...
Le ``binding problem'' est le problème de la réalisation
du lien causal entre les différents constituants d'une scène.
Trouver une forme algorithmique qui sert de support au lien de causalité.

Une forme algorithmique simple est celle de la projection inverse, c'est à 
dire une zone d'activité (ou un neurone) instancie un objet complet, répondant 
de manière sélective à une combinaison spécifique des différents constituants.

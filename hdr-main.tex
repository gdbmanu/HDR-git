...
Une architectures cognitives est un dispositif logiciel dont le but est de permettre à un appareil (disposant de capteurs et
d'actuateurs) d'interagir de façon ``intelligente'' avec son environnement. Le concept de comportement intelligent reste bien sûr assez flou.
On assimilera ici  dispositif logiciel et controlleur. On parlera de signal d'entrée pour qualifier les données analogiques ou digitales à traiter.     
On parlera de commande pour qualifier la réponse (analogique ou digitale) produite par le dispositif.

Ce problème d'une définition opérationnelle de l'intelligence a été posé au sortir de la deuxième guerre mondiale. Il s'agissait de 
construire un programme de recherche, une feuille de route détaillant les étapes nécessaires et suffisantes pour construire un dispositif artificiel
intelligent.
...
A un niveau très général, il s'agit de produire un dispositif dont les réponses s'apparenteraient dans la forme et dans le contenu à celles d'un être humain [TEST DE TURING],
...
l'imputabilité de l'action. Un dispositif logico-mécanique pourrait être dit intelligent s'il était considéré comme responsable de ses actes, 
...
n'est pas véritablement intelligent s'il ne passe pas le test de Turing, ou si on ne peut pas lui imputer les réponses qu'il a produites.
...
On distingue classiquement 3 approches de réalisation de telles architectures. 
\begin{enumerate}

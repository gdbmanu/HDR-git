...
\subsection{Bruit créateur dans les architectures sensori-motrices}
...
physique. La dynamique contrainte d'un tel réseau présente des propriétés de système
...
L'idée est donc d'exploiter cette complexité intrinsèque de la dynamique interne
pour stabiliser des couplages sensori-moteurs par des mécanismes de plasticité 
utilisant des méta-signaux de type ``réussite/échec'', selon le principe de 
l'apprentissage par renforcement.



La traduction naturelle des algorithmes de renforcement dans un contexte de réseau de neurones récurrent est 
l'application d'une règle Hebbienne pour favoriser les comportements conduisant à un méta-signal de positif,
et l'application d'une plasticité anti-hebbienne pour défavoriser les comportements conduisant à un méta-signal négatif.
Une différence enfin liée à la nature de la tâche est la nécessité de prendre en compte (et produire les 
...
L'utilisation de récompenses ponctuelles nécessite par ailleurs de mettre en place un mécanisme de trace synaptique, 
...
Le comportement organisateur des règles Hebbiennes et le comportement désorganisateur des règles anti-Hebbiennes 
était censé produire une comportement plus prédictible tendant à accroître la récompense moyenne.
...
Les changements comportementaux reposent sur l'activité de cette couche secondaire, soumise à
...
L'implémentation de cette règle dans le cadre des réseaux récurrents aléatoires 

Premières implémentations : interprétation concurrente activité / bruit.

L'activité chaotique intrinsèque est remplacée par unn bruit ``lent''. 
Notion de bruit lent, de correspondance des échelles temporelles.

...
Les protocoles d'apprentissage présentés jusqu'ici reposent sur la 
mise en place d'une réponse induite par la plasticité, 
qui rend le réseau plus réactif à certains motifs désignés 
par l'expérimentateur.
Le cadre est donc celui de l'apprentissage supervisé. 
Il s'agit de produire une dynamique de relaxation qui se 
conforme à la contrainte imposée.

L'étude présentée ici a été initiée pendant dans le cadre du master de 
Frédéric Henry et poursuivie et approfondie pendant sa première année
passée à Marseille, et a fait l'objet de deux publications de conférences
et d'un article \cite{Dau06,Henry06,Henry07}.

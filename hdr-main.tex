...
L'application de la STDP sur cette dynamique conduit la dynamique vers   
...
Les protocoles d'apprentissage présentés jusqu'ici 
forment une réponse induite, 
qui rend le réseau plus réactif à certains motifs désignés 
par l'expérimentateur.
Il n'y a pas de read-out, il s'agit juste de produire une dynamique de relaxation qui se 
conforme à la contrainte imposée.

L'étude présentée maintenant a été initiée pendant dans le cadre du master de 
...
L'étude porte sur la discrimination de signaux temporels. Il montre comment l'utilisation
...
Le protocole exploite comme précédemment la dynamique d'un réseau récurrent 
aléatoire constitué de neurones impulsionnels. 
Il utilise sur les effets symétriques des règles hebbiennes et anti-hebbiennes 
...
La tâche consiste à discriminer quatre motifs spatio-temporels possédant
des éléments en communs, de telles sorte qu'il soit impossible de séparer les signaux
sur la base de l'entrée instantanée.
Chaque neurones de sortie représente une des catégories.
Le neurone gagnant est celui qui émet le premier potentiel d'action.
Si la réponse est correcte, la STDP est appliquée sur la couche de sortie et sur la couche récurrente,
ce qui tend à accélérer la réponse du neurone.
Si la réponse est incorrecte, selon
un principe qui se rapproche de l'apprentissage par renforcement, c'est l'anti-STDP qui est appliquée, 
tendant à retarder la réponse.
Différents ``niveaux'' de difficulté ont été utilisés. 
Pour des signaux temporels 

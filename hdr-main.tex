...
L'interaction d'un substrat logiciel avec son milieu passe par des transducteurs, qui sont les canaux de 
...
formée autour de la commande à feedback négatif [CITATION]. 
Les systèmes cybernetiques sont essentiellement des boucles de régulation, qui maintiennent un certain
...
controleur et son environnement.
...
Une première approche consiste à faire en sorte que le logiciel enrichisse le modèle de monde, 
...
être confrontée au modèle. [BABBLING], utile en particulier pour l'apprentissage
des contingences sensori-motrices [SMC - eSMCs].
Cette importance de la commande aléatoire dans l'acquisition de connaissance a été formalisé
dans le cadre de \emph{l'apprentissage par renforcement}. [BARTO SUTTON]
...
selon des modalités variées comme la consommation énergétique, l'exposition aux signaux nociceptifs ou euceptifs, 
...
La plupart des modèles de renforcement reposent sur des [LUT] et souffrent de problèmes
d'explosion combinatoire.

Une autre manière de formaliser ce problème est proposée par [FRISTON]: 

ces améliorations peuvent passer par deux stratégies : 
...
nerveuse.
Par exemple, dans domaine biologique, 
...
Le point de départ pour notre étude dans ce contexte est l'idée de chaos + augmentation/réduction
de la complexité (du bruit) en fonction du degré de connaissance.
...
Ensuite, notion de bruit lent, de correspondance des échelles temporelles.

...
L'élaboration d'un modèle descriptif prenant en compte plusieurs échelles permet alors d'émettre des hypothèeses 
...
\cite{Grillner2008}. D'autres circuits plus récents, comme ceux de l'hippocampe, 
...
La dérivation de la commande motrice à travers le cervelet conduit 
...
Le comportement d'orientation, par opposition aux comportements locomoteurs
ou alimentaires, est constitué de mouvements brefs (discrets).
Ce type de comportement pris en charge par la partie supérieure du tectum
appeleée le colliculus.
...
La saccade oculaire est un mouvement considéré comme élémentaire, consistant à 

Le référentiel rétinien (qui n'est pas le référentiel tête). Nécessité d'une intégration.

Mouvement interrompu. 



mais constitue un excellent
sujet d'étude à la fois en ce qui concerne 

présente à la fois du point de vue

...
neurones. Il implémentait également différentes règles de plasticité synamtique, dont la STDP (Spike-Timing Dependent
Plasticity).
...
Dans des architectures feed-forward, un des effets importants de la STDP est qu'elle réduit la latence de la réponse des neurones 
...
les constantes de temps et les périodes réfreactaires. L'activité produite par ces réseaux apparaît
plus ``désordonnée'' que celle des réseaux à sortie continue. Ainsi, aucune activité de type cycle limite
n'est mise en évidence dans ces réseaux : seules les activités de type chaotiques
sont observées lorsque le réseau est actif; si les liens 
récurrents ne sont pas assez forts, l'activité s'éteint.
L'existence d'une période intrinsèque forte, qui était une des caractéristique des réseaux récurrents 
aléatoires à soprtie continue, n'est pas mis en évidence dans ces modèles.

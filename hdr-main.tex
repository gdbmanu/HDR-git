...
- Recusation de la demarche behavioriste (et problème de l’agentivité) (au sein du machine learning?).
    1. L’expressivité du substrat conditionne le “monde perceptif” (au sens des categories et des relations de voisinage, d’identité, de similarité entre les stimuli sensoriels) (exemple : substrat 1D-2D de la carte de Kohonen). Puissance d’expression. Rq : la demarche de chomsky s’inscrit dans cette démarche (contraintes sur ce qui est exprimable). Notion de “reservoir”. Emergence = instanciation.
...
Perspectives :
- Substrat apprenant universel
- Field computation. Patron (fenêtre) d’interaction anisotropique. La reponse n’est pas un vecteur ou un scalaire mais une distribution.
- Regles de plasticité, information mutuelle et binding. Synchronie des systemes en interaction. Le binding au niveau des schémas d’interaction en miroir. Co-evolution. Mutual information (avec mutual emission et reception). Accrochage de phase. Emergence et non-sens. Independance : est “bindé” ce qui évolue ensemble (non indépendamment). Est “non bindé” ce qui évolue indépendamment. Lié aux DDL? 
⇒ Le substrat est le support de plusieurs processus indépendants. Par analogie au neural field, on peut avoir plusieurs “bulles” sur la carte.
- idée de perméabilité / imperméabilité des echelles BOTTOM → UP. Les etats et les processus des echelles inferieures ne sont pas impactées par les phenomenes d’ordre superieur autrement que par les signaux et les tâches traitées à leur échelle. Exemple : une couche motrice est principalement en train de stabiliser des couplages, pas d’instituer (proclamer/décréter) un nouvel “emploi”. (pas de “downward causation”)
...
2005 
- analogie TD - STDP.  regle de la difference : (Si(t+1) - Si(t)) Sj(t)
...
historique :
- Les architectures de contrôle. Cybernetique.  Asservissement lineaire. Wiener.
- Filtre de Kalman - Modele en miroir. Notion de bruit (d’etat et de mesure). Le bruit est l’expression la plus simple de l’autonomie d’un systeme.
- Gibson / affordance (employabilité/actionnabilité). 
- la synergetique
- les RN et l’apprentissage de la commande: régression (predicteur = classifieur ou regresseur) 
- le RL (acteur/critique)
- Robotique developpementale : Brooks / la subsumption.
- l’espace de contrôle et l’approche “point fixe” du contrôle
- Mosaic
- Friston

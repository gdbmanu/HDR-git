...
NOTION IMPORTANTE DE META-PROGRAMME
...
{\color{Violet}- espace discret d’attracteurs : switching. Notion de “pôle” (ou “mode”?).}
...
(ou unité de séparation dans le cas des classifieurs), l'expressivité d'un substrat est vue en tant que nombre
de patrons distribués (patterns) obtenus en réponse à une stimulation. Si l'expressivité se trouve en principe augmentée
...
Le champ des possibilités d'expression s'étend encore selon le modèle considéré. Ainsi, le modèle du 
``Champ neuronal dynamique'' [CITATION] offre un cadre à la description d'un substrat décrit par un support  
continu (un champ et non plus un réseau de noeuds discrets), dont la dynamique spatio-temporelle est décrite par un jeu
d'équation aux dérivées partielles. L'intérêt de ce modèle est de produire une description explicitement spatialisée
du substrat, et porte en lui une meilleure capacité de représentation (ou de reproduction) 
...
L'exemple des réseaux de neurones artificiels nous offre ainsi une expression logicielle de la notion de substrat matériel
...
Le fil rouge de notre approche est celui des réseaux de neurones à connectivité aléatoire, qui nous permet
de faire un pas supplémentaire en direction des réseaux de neurones naturels.
Le caractère aléatoire des patrons de connectivité tel que nous les modélisons est un cadre permettant de traiter de manière formelle et de quantifier 
...
nous posons la question du rôle de ces distributions dans la formation de patrons d'activité variés, supports potentiels
d'opérations variées. 

Notre approche consiste donc à analyser les capacités d'un réseau de neurones en tant que support potentiel de traitement de l'information. 

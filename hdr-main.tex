...
\section{Bottom-up}\label{sec:bottom}
...
L'approche bottom-up, c'est : le support de lapersistence provient de la multitude de reponses possibles à travers l'espace et à travers le temps.

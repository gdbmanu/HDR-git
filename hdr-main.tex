...
La scène extérieure ``absolue'' doit donc se construire en tant qu'explication
...
Si une scène est explorée sous la forme d'une séquence de couples (posture, scène visuelle),
...
une seule et unique interprétation demeure (la seule à
...
les différents éléments en tant que support n'est pas connue à l'heure actuelle.

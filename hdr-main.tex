...
Le papier qui présente ces idées de la manière la plus complète est celui de Neural Networks, datant de 1998 \cite{Dau98A}.
...
En renforçant les liens entre les neurones les plus actifs, 
elle tend à produire une classe de réactions différente
...
Du point de vue computationnel, la plasticité synaptique inscript dans le substrat une séparation de l'espace

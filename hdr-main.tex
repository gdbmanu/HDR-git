...
Sachant que seule la commande de variation de contraction est communiquée à l'appareil musculaire,
...
identité entre les éléments de l'ancienne scène et ceux de la nouvelle.
Le couplage est donc le processus qui identifie la conséquence sensorielle de l'action au déplacement
d'un \emph{même} objet d'une position sensorielel initiale vers une position sensorielle finale.
Entre la scène sensorielle initiale et la scène sensorielle finale, la commande motrice est l'élément 

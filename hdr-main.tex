...
d'une activité de populaton à un déplacement moteur.
L'hypothèse est que le substrat nerveux est un réservoir de patrons sensori-moteurs, 
...
Ce mécanisme de passage d'échelle est logiquement suivi d'un retour à
l'échelle inférieure, soit une désynchronisation, lorsque les conditions de la synchronisation ne sont plus remplies.
...
Nous allons maintenant essayer de voir quels sont les difficultés posées par cette approche, et quels sont

...
des réponses comportementales automatiques ou induites par l'apprentissages.
La prise en compte des deux domaines matériels que sont le circuit logiciel et le milieu physique
environnant conduit à déplacer le cadre conceptuel de l'apprentissage.
On parle d'apprentissage en ``boucle fermée''.
...
La tâche n'est plus définie par rapport à la justesse des réponses, mais par rapport
à la justesse de ce parcours dans l'espace des trajectoires possibles.

Le niveau explicatif macroscopique

Le logiciel induit des déplacements ou des transformations du monde physique
qui en retour induisent des 


Considérons un dispositif logiciel controlant un appareil 

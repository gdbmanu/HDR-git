...
par \cite{KELLER} dans le cadre de l'étude de la saccade occulaire.
...
sur le dilemne exploration/exploitation bien connu en apprentissage automatique, exprimé sous sa
...
attendus en toute connaissance du modèle.
...
par exemple des politiques non-stochastiques (algorithme UCB), ou en étendant le modèle au cas ``adversairial'' 
(théorie des jeux) \cite{Auer2002}. 

Ce séjour à Lille a été le point de départ d'un travail de collaboration qui s'est concrétisé
...
Une interface cerveau-machine (ICM) est un dispositif qui mesure l'activité électrique 
...
[Nécessite souvent un apprentissage de la part du sujet]

L'idée de départ était de définir un cadre dans lequel le contrôleur s'adapte au sujet, c'est à dire
fait évoluer son fonctionnement selon des caractéristiques propres au sujet.
Il a été pour moi l'occasion de développer différentes approches dans le cadre 
d'une des applications les plus connues des interfaces cerveau machine (ICM)~: le ``P300-speller''.  

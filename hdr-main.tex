...
Par ailleurs, la présence de séquences d'activation spatio-temporelles (dites ``groupes polychrones'') 
plus spécifiques aux modèles à spikes, telles que postulées par [IZHIKEVICH] en tant
qu'unités opérationnelles élémentaires, sont exploités comme supports d'une mémoire à court terme dans 
\cite{Dau06,Hen07}.

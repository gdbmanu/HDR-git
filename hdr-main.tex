...
Une hypothèse pour la formation des actions et 'autonomie logicielle 
...
\paragraph{Commande de point fixe ou vélocité}


: une succession de correspondances
...
permanence de l'objet à travers les transformations.

...
En fait, celà ne pose pas de problème lorsqu'il s'agit d'associer (de manière univoque) un
patron d'activité (un attracteur) et une commande motrice. Une activité de population est parfaitement capable de définir
un déplacement moteur dans l'espace métrique, sur le mode de la carte colliculaire vue précédemment.
Le problème se pose lorsqu'il s'agit de \emph{mettre en relation} différents patrons d'activité pour établir
une réponse motrice relative (par exemple relative à la distance entre deux objets de l'espace métrique).

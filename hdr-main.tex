...
1. Nature des représentations. Quelle est la représentation adéquate. Représentation de type symbolique (langagière)?
Représentation de type mécanique (copie du système extérieur). La nature du monde interieur est-elle in fine symbolique ou 
mecanistique?
...
(1) logico-symbolique. Focus sur la dualité donnée-programme. Traitement (calculateur) ``digital''.
...
(2) Mécanique. Focus sur l'action et l'imputabilité. Question : qui commande? Principe de la régulation (cybernétique). Traitement (calculateur) ``analogique''. 
